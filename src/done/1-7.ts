...
// ArrayBuffer = 一塊固定長度的原始二進位資料緩衝區，本身不能直接讀寫資料，需要透過「視圖」(View) 來操作
// TypedArray = 用來操作 ArrayBuffer 的視圖
// ============================================
...
console.log('Reflect.has:', Reflect.has(target, 'name')); // true，表示 target 有 name 屬性
console.log('Reflect.get:', Reflect.get(target, 'name')); // Original，取得 name 屬性值
...
console.log('\n=== Intl 國際化 ===');
// Intl 是一個「命名空間 / 全域物件」，裡面放各種國際化格式化的“建構函式
// 日期格式化
